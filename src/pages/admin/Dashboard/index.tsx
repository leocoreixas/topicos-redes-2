...
function Dashboard() {
    ...
    const [pagesList, setPagesList] = useState([
        ...
        { id: 2, title: 'Jogar', description: 'Aqui você jogará o Rally da Sorte, porém, para isso, precisa ter carros para jogar. Você pode comprar carros na aba "Comprar Carros" e depois entrar em Garagem para selecionar o carro que deseja jogar. O jogo ocorre da seguinte maneira: você escolhe um carro'},
        { id: 3, title: 'Minhas Corridas', description: 'Aqui você poderá ver o histórico de corridas, para isso, basta clicar em "Minhas Corridas".'},
        { id: 4, title: 'Garagem', description: 'Aqui você poderá configurar o carro que deseja jogar, para isso, basta selecionar o carro desejado na lista'},
    ]);
    ...
    return (
        <>
            <div className="p-10">
                <div className="bg-primary-l mt-4 mb-4 p-8 rounded-2xl border border-gray-200 flex flex-col gap-2">
                    <Typography className="text-2xl font-bold mb-4" color="primary-m" variant="h1" tag={'symbol'}>Bem vindo ao Rally da Sorte!</Typography>
                ...
                <div className="cursor-pointer p-8 rounded-2xl border border-gray-200 flex justify-center items-center gap-2 bg-primary-m hover:bg-primary-d transition duration-500" onClick={() => navigate('/jogar')}>
